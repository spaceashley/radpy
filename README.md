...
Elliott, Ashley (2025). *RADPy: Robust Angular Diameters in Python*. Version 0.5.2. Available on PyPI: https://pypi.org/project/rsadpy. Source code: https://github.com/spaceashley/radpy
